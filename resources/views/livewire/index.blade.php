<div>
    <div class="row gx-5 align-items-center mb-5">
        <div class="col-xxl-5">
            ...
            <div class="text-center text-xxl-start">
                ...
                <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Get online and grow fast</span>
                </h1>
                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                    <a class="btn_ btn_-primary btn_-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="resume.html">Resume</a>
                    <a class="btn_ btn_-outline-dark btn_-lg px-5 py-3 fs-6 fw-bolder" href="projects.html">Projects</a>
                </div>
            </div>
        </div>
        <div class="col-xxl-7">
    ...
    <section class="bg-light py-5" style="border-radius: 1em;">
                ...
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit dolorum
                            itaque qui
                            unde quisquam consequatur autem. Eveniet quasi nobis aliquid cumque officiis sed rem iure
                            ipsa!
